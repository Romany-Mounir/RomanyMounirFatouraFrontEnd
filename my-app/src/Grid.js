...
import TurnCounter from './Components/SharedComponents/TurnCounter';
...
export default function Grid() {
    ...
    var elements = [];
    var colorarr = ['black', 'black', 'black', 'green', 'green', 'green', 'green', 'green', 'green', 'green', 'green', 'green', 'green', 'green', 'green', 'green', 'yellow', 'yellow', 'yellow', 'yellow', 'yellow', 'yellow', 'yellow', 'yellow', 'yellow',];
    for (var i = 0; i < 25; i++) {
...
console.log(game)
    ...
    // }
        ...
        // while (cardsColorArray.length < 25) {
        //     var colorRandom = colorarr[Math.round(Math.random() * (colorarr.length-1))];
        //     console.log(cardsColorArray);
        //     switch (colorRandom) {
        //         case 'black':
        //             cardsColorArray.map((item) => item === 'black' && item).length < 3 && cardsColorArray.push('black');
        //             break;
        //         case 'green':
        //             cardsColorArray.map((item) => item === 'green' && item).length < 13 && cardsColorArray.push('green');
        //             break;
        //         case 'yellow':
        //             cardsColorArray.map((item) => item === 'yellow' && item).length < 9 && cardsColorArray.push('yellow');
        //             break;
        //         default:
        //             break;
        //     }
        ...
        return (
            <Container className="">
                <Row className="my-5 bg-warning p-3">
                    ...
                    <Col className="text-black"><h1>Code Names
                    </h1></Col>


                </Row>
                <Row className="mb-2 text-white d-flex justify-content-center">
                    <Col><h3 className="bg-dark p-3 rounded">Turns left</h3> </Col>
                    <Col><TurnCounter /></Col>
                ...
                <Row className="m-2  d-flex justify-content-center">
                    {elements.map((element,index) =>
                        <Col xs={2} key={index} className="m-2 p-2 bg-white rounded border offset2">
                            <h4>{element}</h4>
                        </Col>
                    )}
                </Row>
                ...
                <Row className="mb-2 text-white">
                    ...
                    <Col className="py-3"><Button variant="success" className="py-3 my-5" type="submit">
                        <h3>Pass</h3>
                    </Button></Col>
